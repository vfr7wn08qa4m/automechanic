...
class RepairCase(BaseModel):
    ...
    system: str = ""                  # подсистема ЛЮБОГО ремонта: двигатель, ГРМ, ЦПГ,
                                      # КПП/DSG, подвеска, тормоза, кузов, а также
                                      # электрика — стартер, генератор, CAN, ЭБУ, датчики...
    ...
    off_topic: bool = False           # НЕ конкретный ремонт/диагностика авто
                                      # (обзор/реклама/влог/теория). Любой реальный
                                      # ремонт — электрика/механика/двигатель/кузов — в теме
